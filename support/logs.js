...
const whClient =  new Discord.WebhookClient(`865088968767832064`, process.env.WEBHOOK_TOKEN);
...
exports.commandLog = async (bot, command, message, args) => {
...
exports.noCommandLog = async (bot, command, message, args) => {
    whClient.client.send(new Discord.MessageEmbed()
        .setColor(config.COLOR)
