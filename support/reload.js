...
//## Reload function ##\\
exports.reload = async (bot, message, args, owners, staff) => {
    ...
    //Permissions check
    if (!owners.includes(message.author.id) && !staff.includes(message.author.id)) return message.channel.send(reloadEmbed);
